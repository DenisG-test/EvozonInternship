...
public class ShoppingCart {
    ...
    public void addProductToCartAssignment() {
    ...
    public void removeProductToCartAssignment() {
        page.navigate("http://qa2magento.dev.evozon.com/");
    ...
    public static void main(String[] args) {
        ...
        shoppingCart.setup();
        shoppingCart.addProductToCartAssignment();
        shoppingCart.removeProductToCartAssignment();
        shoppingCart.close();
    }
}
